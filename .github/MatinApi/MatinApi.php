<h1>But the right to change the name of the class, order, and function or the word that matin has, and after personalization, there is no copyright, and otherwise, legal action will be taken.
After Read if you use this Api you You accepted the law.
</h1>
<?php
        ...
        <html>
          ...
          <body>
            <div class="macbook-pro">
              <div class="div">
              <div style="font-size: 30px;" class="text-wrapper">Version:Beta</div>
